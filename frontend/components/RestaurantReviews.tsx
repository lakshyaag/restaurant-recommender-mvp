...
import { RestaurantReview, BusinessContextScores, defaultBusinessContext, businessHighlights, getReviews } from "@/lib/constants/mock-reviews";
...
import { Star, ThumbsUp, Volume2, Users, Coffee, BadgeCheck, MessageCircle } from "lucide-react";
            ...
            >
              <div className="space-y-4 pt-2">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm">{getScoreLabel(defaultBusinessContext.noiseLevel)}</span>
                  </div>
                  <Progress value={defaultBusinessContext.noiseLevel * 20} className="h-2" />
                </div>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm">{getScoreLabel(defaultBusinessContext.privacyLevel)}</span>
                  </div>
                  <Progress value={defaultBusinessContext.privacyLevel * 20} className="h-2" />
                </div>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium">Formality Level</span>
                    </div>
                    <span className="text-sm">{getScoreLabel(defaultBusinessContext.formalityLevel)}</span>
                  </div>
                  <Progress value={defaultBusinessContext.formalityLevel * 20} className="h-2" />
                </div>
              </div>
              ...
              <div className="my-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {defaultBusinessContext.meetingTypes.map((type, index) => (
              ...
              {/* Highlights */}
              <div className="pb-2">
                <h4 className="text-sm font-medium mb-2">Business Highlights:</h4>
