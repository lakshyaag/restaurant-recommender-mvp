...
const clientProfileSchema = z.object({
	clientDesignation: z.enum([...CLIENT_DESIGNATIONS.map(item => item.value)] as [string, ...string[]], {
	...
	meetingDuration: z.enum([...MEETING_DURATIONS.map(item => item.value)] as [string, ...string[]], {
...
const ClientProfileForm = () => {
	...
	const { searchRestaurants, isLoading, setSearchParams } = useRestaurantStore();
			...
			>
                ...
                <div className="space-y-4 pt-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-medium">Preferences & Additional Details</h3>
                    </div>
                    <Separator className="my-2" />
                ...
                <div className="pt-4">
                    <Button 
                        ...
                        className="w-full"
                    >
                        {isLoading || isSubmitting ? "Processing..." : "Find Restaurants for Client"}
                    </Button>
                </div>
			</form>
		</Form>
