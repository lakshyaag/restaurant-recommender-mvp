...
export function useRestaurantSearch() {
  ...
  const [region, setRegion] = useState<{center: {latitude: number, longitude: number}} | null>(null);
  ...
  const searchByLocation = (location: string, options: Omit<SearchParams, 'location'> = {}) => {
